...
const ScheduleSection = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-16 md:py-24">
      <div id='SCHEDULE' className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24">
        {/* Left side - Image */}
        ...
        <div className="w-full md:w-1/2">
          ...
          <button
            className="text-blue-500 font-semibold flex items-center gap-2 hover:gap-4 transition-all duration-300 group cursor-pointer bg-transparent border-none p-0"
